...
export const projects: ProjectInfo[] = [
...

  {
    title: "Blog Cutter",
    description:
      "Una aplicación Android para cortar videos largos de forma eficiente.",
...

  {
    ...
    description:
      "Un videojuego multijugador online en el que te enfretarás en un 1v1. Desarrollado para una Game Jam.",
